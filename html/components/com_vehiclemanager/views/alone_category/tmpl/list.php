...
<?php if (count($rows) > 0): ?>
    ...
    if($params->get('show_input_button_search')):?>
        ...
        <div class="search_button_vehicle_container
            <?php if ( $option_type == 'com_simplemembership'  && $params->get('show_input_add_vehicle')){ //disable order enable add button // ?>
            ...
            <?php } else if( !$params->get('show_input_add_vehicle') && $option_type != 'com_simplemembership'  ){ //disable  add button  enable order  ?>
    ...
    <div id="list">
           ...
           <a href="<?php echo sefRelToAbs($link); ?>" style="text-decoration: none" >
                                ...
                                $file_name = vm_picture_thumbnail($imageURL, $vehiclemanager_configuration['foto']['high'],
                                  $vehiclemanager_configuration['foto']['width'], $watermark_path);
                      ...
                      <span class="col_02">
                            <a href="<?php echo sefRelToAbs($link); ?>" class="category<?php
                               echo $params->get('pageclass_sfx'); ?>">
                                 <?php echo words_limit($row->vtitle, 10, '...'); ?>
                            </a>
                        </span>
                        <div class="vm_price">
          <?php
  ...
  <!--       <br /> -->
              <?php if ($row->maker != '' || $row->vmodel !== 0 && trim($vehicle->vmodel) !== "") {
    ?>
    <div class="vm_model">
        <i class="fa fa-car"></i>
...
<?php } if ($row->vmodel !== 0 && trim($vehicle->vmodel) !== "") { ?>
    ...
    <?php
        ...
        <div class="col_03">
                                            <?php echo words_limit($row->description, 30, '...'); ?>
        </div>
<div class="vm_type_catlist">
            <?php
                    $link1 = 'index.php?option=com_vehiclemanager&amp;task=showCategory&amp;catid=' .
                      $row->catid . '&amp;Itemid=' . $Itemid;
                ?>
                        <div class="col_12">
                            <i class='fa fa-tag'></i>
                            <a href="<?php echo JRoute::_($link1, false); ?>" class="category<?php
                              echo $params->get('pageclass_sfx'); ?>">
