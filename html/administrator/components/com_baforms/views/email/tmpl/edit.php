    ...
    <div class ="row-fluid">
        <div class="span2 content">
            ...
            <div class="text-items">
                <div class="tool">
                    <div class="textbox">
                        <p><?php echo JText::_('SUBMISSION_ID') ?></p>
                    </div>
                    <div class="model">
                        <p class="shortcode-field">[submission ID]</p>
                    </div>
                </div>
            </div>
            <div class="text-items">
                <div class="tool">
                    <div class="textbox">
                        <p><?php echo JText::_('PAGE_TITLE') ?></p>
                    </div>
                    <div class="model">
                        <p class="shortcode-field">[page title]</p>
                    </div>
                </div>
            </div>
            <div class="text-items">
                <div class="tool">
                    <div class="textbox">
                        <p><?php echo JText::_('PAGE_URL') ?></p>
                    </div>
                    <div class="model">
                        <p class="shortcode-field">[page URL]</p>
                    </div>
                </div>
            </div>
        </div>
