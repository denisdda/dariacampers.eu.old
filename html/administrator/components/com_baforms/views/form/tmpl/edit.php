...
<script src="<?php echo JUri::root(true) . '/media/jui/js/jquery.minicolors.min.js'; ?>" type="text/javascript"></script>
...
<?php
    if ($this->about->tag == 'pro' && isset($formsState->data)) {
?>
        <label class="column mailchimp-integration">
            <img src="components/com_baforms/assets/images/mailchimp.png">
            <p>MailChimp</p>
        </label>
        <label class="column telegram-integration">
            <img src="components/com_baforms/assets/images/telegram.png">
            <p>Telegram</p>
        </label>
        <label class="column google-sheets-integration">
            <img src="components/com_baforms/assets/images/google-sheets.png">
            <p>Google Sheets</p>
        </label>
        <label class="column acymailing-integration">
            <img src="components/com_baforms/assets/images/acymailing.png">
            <p>Acymailing</p>
        </label>
        <label class="column acym-integration">
            <img src="components/com_baforms/assets/images/acymailing.png">
            <p>Acymailing 6</p>
        </label>
<?php
...
<div id="stripe-image-dialog" class="select-image-modal modal hide ba-modal-lg" style="display:none">
    <div class="modal-body">
        <iframe name="stripe-image-dialog"
...
?>
    ...
    <div id="google-maps-integration-modal" class="modal hide ba-modal-md" style="display:none">
        ...
        <div class="modal-body">
            ...
            <a href="https://developers.google.com/maps/documentation/javascript/" target="_blank"
                class="ba-btn-primary">Get your API Key</a>
        </div>
        <div class="modal-footer">
    ...
    <div id="acymailing-integration-modal" class="modal hide ba-modal-md" style="display:none">
        <div class="modal-header">
            <h3>Acymailing</h3>
        </div>
        <div class="modal-body">
            <label><?php echo JText::_('LISTS') ?></label>
            <select multiple class="acymailing-lists">
                <?php echo baformsHelper::getAcymailingLists(); ?>
            </select>
            <?php echo $this->form->getInput('acymailing_lists'); ?>
            <label><?php echo JText::_('MATCH_YOUR_FIELDS'); ?></label>
            <div class="match-acymailing">
<?php
            /*
            foreach ($this->acymailingFields as $acymailingField) {
                $fieldname = str_replace('NAMECAPTION', 'Name', $acymailingField->fieldname);
                $fieldname = str_replace('EMAILCAPTION', 'Email', $fieldname);
?>
                <div class="acymailing-name">
                    <label><?php echo $fieldname; ?></label>
                    <select class="form-fields" data-field="<?php echo $acymailingField->namekey; ?>">
...
?>
                <div class="acymailing-name">
                    <label>Name</label>
                    <select class="form-fields" data-field="name">
                        <option value=""><?php echo JText::_('SELECT'); ?></option>
                    </select>
                </div>
                <div class="acymailing-name">
                    <label>Email</label>
                    <select class="form-fields" data-field="email">
                        <option value=""><?php echo JText::_('SELECT'); ?></option>
                    </select>
                </div>
            </div>
            <?php echo $this->form->getInput('acymailing_fields_map'); ?>
        </div>
        <div class="modal-footer">
            <a href="#" class="ba-btn-primary" data-dismiss="modal"><?php echo JText::_('APPLY') ?></a>
            <a href="#" class="ba-btn" data-dismiss="modal"><?php echo JText::_('CLOSE') ?></a>
    ...
    <div id="acym-integration-modal" class="modal hide ba-modal-md" style="display:none">
        <div class="modal-header">
            <h3>Acymailing 6</h3>
        </div>
        <div class="modal-body">
            <label><?php echo JText::_('LISTS') ?></label>
            <select multiple class="acym-lists">
                <?php echo baformsHelper::getAcymLists(); ?>
            </select>
            <?php echo $this->form->getInput('acym_lists'); ?>
            <label><?php echo JText::_('MATCH_YOUR_FIELDS'); ?></label>
            <div class="match-acym">
<?php
            /*
            foreach ($this->acymFields as $acymField) {
                $fieldname = str_replace('ACYM_NAME', 'Name', $acymField->name);
                $fieldname = str_replace('ACYM_EMAIL', 'Email', $fieldname);
?>
                <div class="acym-name">
                    <label><?php echo $fieldname; ?></label>
                    <select class="form-fields" data-field="<?php echo $acymField->namekey; ?>">
                        <option value=""><?php echo JText::_('SELECT'); ?></option>
                    </select>
                </div>
<?php
...
?>
            ...
            <?php echo $this->form->getInput('acym_fields_map'); ?>
        </div>
        <div class="modal-footer">
            <a href="#" class="ba-btn-primary" data-dismiss="modal"><?php echo JText::_('APPLY') ?></a>
            <a href="#" class="ba-btn" data-dismiss="modal"><?php echo JText::_('CLOSE') ?></a>
    ...
    <div id="google-sheets-integration-dialog" class="modal hide ba-modal-md" style="display:none">
        <div class="modal-header">
            <h3>Google Sheets</h3>
        </div>
        <div class="modal-body">
            <div>
                ...
                <?php echo $this->form->getInput('google_sheets'); ?>
                <input type="text" value="<?php echo $this->sheets->code; ?>" id="google_sheets_code">
                <input type="button" class="ba-btn apply-google-sheets-code" value="<?php echo JText::_('APPLY'); ?>">
                <div class="mailchimp-message" style="display: none;"></div>
                <a href="<?php echo $this->sheets->authUrl; ?>" target="_blank"
                    class="ba-btn-primary google-sheets-login">Login</a>
            </div>
            <div>
                <label>Spreadsheets</label>
                <select class="google-sheet-spreadsheets" disabled data-key="spreadsheet">
                    <option value=""><?php echo JText::_('SELECT') ?></option>
                </select>
            </div>
            <div>
                <label>Worksheets</label>
                <select class="google-sheet-worksheets" disabled data-key="worksheet">
                    <option value=""><?php echo JText::_('SELECT') ?></option>
                </select>
            </div>
            <label><?php echo JText::_('MATCH_YOUR_FIELDS'); ?></label>
            <div class="merge-google-sheets-fields">
...
?>
            ...
            <div class="box-fields">
                ...
                <div class="tool">
                    <div class="textbox">
                        <p><?php echo JText::_('TERMS_CONDITIONS') ?></p>
                    </div>
                    <div class='model'>
                        <div class="ba-terms-conditions">
                            <span>
                                <input type="checkbox">
                            </span>
                            <div class="terms-content"><p>I accept the <a href="#">Terms and Conditions</a>.</p></div>
                        </div>
                        <input type="hidden" class="ba-options">
                    </div>
                </div>
...
?>
            <div class="image-field">
                <div class="tool">
                    ...
                    <div class='model' style="text-align: center;">
            ...
            <div class="page-break">
                ...
                <div class='model'>
                    <div>
                        ...
                        <div class="ba-save-continue" style="display: none;">
                            <a href="#"></a>
                            <span class="ba-tooltip"><?php echo JText::_('CLICK_TO_EDIT') ?></span>
                        </div>
                    </div>
