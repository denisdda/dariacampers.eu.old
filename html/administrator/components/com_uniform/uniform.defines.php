<?php
/**
 * 4.1.25     $Id: uniform.defines.php 19014 2012-11-28 04:48:56Z thailv $
 * @package     JSNUniform
 * @subpackage  Config
...
define('JSN_UNIFORM_VERSION', '4.1.25');
...
//php excel
define('JSN_UNIFORM_LIB_PHPEXCEL', JPATH_ROOT . '/administrator/components/com_uniform/libraries/3rd-party/php-excel.class.php');

//tcpdf library
define('JSN_UNIFORM_LIB_TCPDF', JPATH_ROOT . '/administrator/components/com_uniform/libraries/3rd-party/tcpdf/tcpdf.php');
