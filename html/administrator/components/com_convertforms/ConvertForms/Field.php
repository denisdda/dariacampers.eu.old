...
class Field
{
	...
	public function setField($field)
	{
		...
		// Support language strings on the following field attributes
		...
		{
			$field->{$translatableProperty} = isset($field->{$translatableProperty}) && $field->{$translatableProperty} != '' ? \JText::_($field->{$translatableProperty}) : '';
		}
