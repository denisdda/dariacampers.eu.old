...
<nav class="navbar-expand-<?php echo $navigation_settings->get('option_breakpoint', 'lg')?>">
    <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#<?php echo $navid ?>" aria-controls="t4Megamenu" aria-expanded="false" aria-label="Toggle navigation">
