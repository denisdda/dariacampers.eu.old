...
<div id="sp_quickcontact<?php echo $uniqid ?>" class="sp_quickcontact">
	...
	<form id="sp-quickcontact-form">
		...
		<div class="sp_qc_clr"></div>
		<input type="text" name="email" id="email" onfocus="if (this.value=='<?php echo $email_text ?>') this.value='';" onblur="if (this.value=='') this.value='<?php echo $email_text ?>';" value="<?php echo $email_text ?>" required />
		<div class="sp_qc_clr"></div>
