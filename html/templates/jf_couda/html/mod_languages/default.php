...
?>
<div class="mod-languages<?php echo $moduleclass_sfx; ?> dropdown-menu">
<?php if ($headerText) : ?>
	...
	<?php foreach ($list as $language) : ?>
		<?php if ($params->get('show_active', 0) || !$language->active) : ?>
			...
			<?php if ($params->get('image', 1)) : ?>
				<?php echo $language->title_native; ?> <?php echo JHtml::_('image', 'mod_languages/' . $language->image . '.gif', $language->title_native, array('title' => $language->title_native), true); ?>
			<?php else : ?>
