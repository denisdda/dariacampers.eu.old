...
<div id="k2ModuleBox<?php echo $module->id; ?>" class="k2ItemsBlock<?php if($params->get('moduleclass_sfx')) echo ' '.$params->get('moduleclass_sfx'); ?>">
	...
	<?php 
		...
		if ($params->get('getChildren')) {
			...
			$query = "SELECT name, alias
						...
						WHERE parent IN (".implode(',', $catid).")
						AND id NOT IN (".implode(',', $catid).") 
						AND published=1
						AND trash=0";
			$db->setQuery($query);
	...
	<div class="container portfolio-filter">
		<ul class="reset-list">
			...
			<li class="filter-item" data-filter=".<?php echo $category->alias ?>">
  ...
  <ul class="portfolio-wrapper">
    ...
    <li class="portfolio-item <?php echo $item->categoryalias; ?>">
      ...
      <span class="moduleItemDateCreated"><?php echo JHTML::_('date', $item->created, JText::_('TPL_JF_COUDA_DATE_FORMAT')); ?></span>
      <?php endif; ?>
