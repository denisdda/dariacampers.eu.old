...
<div id="k2ModuleBox<?php echo $module->id; ?>" class="k2ItemsBlock<?php if($params->get('moduleclass_sfx')) echo ' '.$params->get('moduleclass_sfx'); ?>">
  ...
  <ul>
    ...
    <li class="col-sm-4 <?php echo ($key%2) ? "odd" : "even"; if(count($items)==$key+1) echo ' lastItem'; ?>">
      ...
      <span class="moduleItemDateCreated"><?php echo JHTML::_('date', $item->created, JText::_('TPL_JF_COUDA_DATE_FORMAT_SHORT')); ?></span>
      <?php endif; ?>
			...
			<?php if($params->get('itemCommentsCounter') && $componentParams->get('comments')): ?>
				...
				<?php else: ?>
					...
					<a class="moduleItemComments" href="<?php echo $item->link.'#itemCommentsAnchor'; ?>">
						<span class="icon-bubbles4"><b><?php echo $item->numOfComments; ?></b></span>
					</a>
					<?php else: ?>
					<a class="moduleItemComments" href="<?php echo $item->link.'#itemCommentsAnchor'; ?>">
