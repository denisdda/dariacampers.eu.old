...
<div id="k2Container" class="itemView<?php echo ($this->item->featured) ? ' itemIsFeatured' : ''; ?><?php if($this->item->params->get('pageclass_sfx')) echo ' '.$this->item->params->get('pageclass_sfx'); ?>">
	...
	<div class="row">
		...
		<div class="col-sm-5">
			...
			<?php if(!empty($this->item->fulltext) || !empty($this->item->introtext)) : ?>
				<h3><?php echo JTEXT::_('TPL_JF_COUDA_PROJECT_DESCRIPTION'); ?></h3>
			<?php endif; ?>
			
			<?php if($this->item->params->get('itemDateCreated')): ?>
			<!-- Date created -->
			<span class="itemDateCreated">
				<?php echo JHTML::_('date', $this->item->created , JText::_('TPL_JF_COUDA_DATE_FORMAT')); ?>
			</span>
			<?php endif; ?>
			...
			<div class="itemCommentsLink">
						...
						<a class="k2Anchor" href="<?php echo $this->item->link; ?>#itemCommentsAnchor">
							<span class="icon-bubbles4"><b><?php echo $this->item->numOfComments; ?></b></span>
						</a>
						<?php else: ?>
						<a class="k2Anchor" href="<?php echo $this->item->link; ?>#itemCommentsAnchor">
							<span class="icon-bubbles4"><b>0</b></span>
						</a>
						<?php endif; ?>
						<?php endif; ?>
			</div>
			...
			<div class="itemBody">
				...
				<div class="itemExtraFields">
					<h3><?php echo JText::_('TPL_JF_COUDA_PROJECT_DETAILS'); ?></h3>
					<ul>
						<?php foreach ($this->item->extra_fields as $key=>$extraField): ?>
						<?php if($extraField->value != '' && $extraField->type != 'link'): ?>
				...
				<div class="itemTagsBlock">
					<span><?php echo JText::_('TPL_JF_COUDA_TAGS'); ?>:</span>
						<ul class="itemTags">
	...
	<div class="itemComments">
		...
		<ul class="itemCommentsList">
			...
			<li class="<?php echo ($key%2) ? "odd" : "even"; echo (!$this->item->created_by_alias && $comment->userID==$this->item->created_by) ? " authorResponse" : ""; echo($comment->published) ? '':' unpublishedComment'; ?>">
				...
				<span class="commentDate"><?php echo JHTML::_('date', $comment->commentDate, JText::_('TPL_JF_COUDA_DATE_FORMAT')); ?></span>
		...
		<ul class="owl-carousel">
			...
			<li class="<?php echo ($key%2) ? "odd" : "even"; ?>">
				...
				<div class="itemRelCreated">
					<?php echo JHTML::_('date', $item->created , JText::_('TPL_JF_COUDA_DATE_FORMAT')); ?>
				</div>
